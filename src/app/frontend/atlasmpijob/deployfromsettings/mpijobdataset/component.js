 ...
 * @final
 */
export class MpiJobDataSetController {
  /** @ngInject */
  constructor() {
    /**
 ...
 */
export const mpiJobDataSetComponet = {
  controller: MpiJobDataSetController,
  controllerAs: 'ctrl',
  templateUrl: 'atlasmpijob/deployfromsettings/mpijobdataset/environmentvariables.html',
  bindings: {
    'variables': '=',
  },
};
