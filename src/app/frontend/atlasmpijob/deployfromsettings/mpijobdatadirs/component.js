 ...
 * @final
 */
export class MpiJobDataDirsController {
  /** @ngInject */
  constructor() {
    /**
 ...
 */
export const mpiJobDataDirsComponent = {
  controller: MpiJobDataDirsController,
  controllerAs: 'ctrl',
  templateUrl: 'atlasmpijob/deployfromsettings/mpijobdatadirs/environmentvariables.html',
  bindings: {
    'variables': '=',
  },
};
