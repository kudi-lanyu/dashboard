 ...
 * @final
 */
export class MpiJobEnvsController {
  /** @ngInject */
  constructor() {
    /**
 ...
 */
export const mpiJobEnvsComponent = {
  controller: MpiJobEnvsController,
  controllerAs: 'ctrl',
  templateUrl: 'atlasmpijob/deployfromsettings/mpijobenvs/environmentvariables.html',
  bindings: {
    'variables': '=',
  },
};
