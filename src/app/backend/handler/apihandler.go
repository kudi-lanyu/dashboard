...
//func (apiHandler *APIHandler) handleGetAtlasTopNode(request *restful.Request, response *restful.Response) {
//  k8sClient, err := apiHandler.cManager.Client(request)
//  if err != nil {
//    kdErrors.HandleInternalError(response, err)
//    return
//  }
//
//  nodeInfoList, err := atlasnode.GetAllNodeInfos(k8sClient)
//  if err != nil {
//    kdErrors.HandleInternalError(response, err)
//    return
//  }
//  response.WriteHeaderAndEntity(http.StatusOK, nodeInfoList)
//}
//
//func (apiHandler *APIHandler) handleGetAtlasTopJob(request *restful.Request, response *restful.Response) {
//  k8sClient, err := apiHandler.cManager.Client(request)
//  if err != nil {
//    kdErrors.HandleInternalError(response, err)
//    return
//  }
//
//  list, err := atlasnode.GetAllNodeInfos(k8sClient)
//  if err != nil {
//    kdErrors.HandleInternalError(response, err)
//    return
//  }
...
func (apiHandler *APIHandler) handleAtlasTasksMpiJob(request *restful.Request, response *restful.Response) {
  ...
  isDeployed, err := atlasmpijob.DeployAtlasMpiJob(cfg, atlasMpiJobSpec)
  if !isDeployed {
    kdErrors.HandleInternalError(response, err)
    return
  }
